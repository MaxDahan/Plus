...
public class Main implements Runnable{
	...
	public Main() throws Exception {
		...
		File file = new File("data\\Snowball\\Cover.jpg");
		...
		try {
	 	...
	 	JLabel startL = new JLabel(new ImageIcon(image));
	...
	public void control() {
		...
		//Background
		File file = new File("data\\Snowball\\CoverBlank.jpg");
		String path = file.getAbsolutePath();
		file = new File(path);
	    BufferedImage image = null;
		try {
	 	...
	 	controlBack = new JLabel(new ImageIcon(image));
		...
		//Back arrow
		file = new File("data\\Snowball\\arrow.png");
        ...
        controlB3 = new JButton(new ImageIcon(image));
        controlB3.setBounds(30, 25, image.getWidth(), image.getHeight());
	...
	public void controlInfo() {
        ...
        back.setBounds(30, 20, image.getWidth(), image.getHeight());
